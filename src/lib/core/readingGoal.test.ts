...
const startOf2023 = new Date(Date.UTC(2023, 0));

describe('A Reading Goal', () => {
  beforeEach(() => {
    vi.useFakeTimers();
    vi.setSystemTime(startOf2023);
  });
  ...
  it('should recalculate pages to read when the date changes', () => {
    ...
    vi.setSystemTime(addMonths(startOf2023, 6));
  ...
  it('should reset stats of the day on a new day', () => {
    ...
    vi.setSystemTime(addDays(startOf2023, 2));
